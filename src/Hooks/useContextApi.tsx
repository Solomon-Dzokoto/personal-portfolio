...
const UseProvider = ({children}:Props) => {
    ...
    const [primaryColor, setPrimaryColor] = useState<string>("#28a745");
    const [backgroundColor, setBackgroundColor] = useState<string>("white");
    const [isPrime,setIsPrime]=useState<boolean>(true)
  return (
    <context.Provider value={{setIsPrime,isPrime,isOpen,setIsOpen,primaryColor,setPrimaryColor,backgroundColor,setBackgroundColor}}>
      {children}
    </context.Provider>
  )
}
