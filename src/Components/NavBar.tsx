  ...
  return (
    <nav>
      <ul
        className={`fixed ${
          onScroll
            ? "translate-y-0 md:translate-y0"
            : "translate-y-[55rem] md:translate-y-0"
        } 
        z-50 md:relative md:bottom-0 md:left-1/2 bottom-0 left-1/2 transform -translate-x-1/2 bg-primary py-2 
